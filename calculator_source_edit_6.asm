...
0 0011 1111	0043	00 00100 1101		BIZ	PLSKEY ; MINUS KEY AS SIGN AFTER MULT OR DIVIDE
0 0100 0100	0044	10 10111 0001		ZFB	OP2
...
0 0100 1010	004A	00 00000 0111		BET	S
...
0 0101 1110	005E	10 11000 0111		ZFA	F9 ; set DPT flag, cler FST flag
...
0 1110 0010	00E2	10 10011 0101		SFB	F5 ; A exponent < 0 - overflow
...
0 1111 0111	00F7	00 01110 1101		BINC	D2 ; Repeat for the next digit if no overflow
0 1111 1000	00F8	10 10111 0101		ZFB	F5 ; Reset overflow flag
0 1111 1001	00F9	00 01110 1101		BET	D2 ; and keep going
0 1111 1010	00FA	10 10011 0101	.ERR	SFB	F5 ; Divide by zero - Set overflow flag
...
1 0001 0001	0111	00 00010 1011	.ID5	BET	ID4
...
1 0010 0110	0126	00 10010 0010		BET	P8
1 0010 0111	0127	00 00010 1011	.ID3	BET	ID4
1 0010 1000	0128	00 00001 0101	.FD4	BET	DPTPOS
1 0010 1001	0129	11 00001 0000	.P9	AAKA	DPT7
1 0010 1010	012A	00 00000 0101		BET	RJ
