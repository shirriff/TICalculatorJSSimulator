...
//
Reset flag A all
0 0000 0000	0000	10 11000 1111	.CLEAR	ZFA	ALL		// POWER ON
Reset flag B all
0 0000 0001	0001	10 10111 1111		ZFB	ALL
0 -> A all
0 0000 0010	0002	11 10000 1111		AKA	ALL
0 -> C all
0 0000 0011	0003	11 10010 1111		AKC	ALL
triangle
0 0000 0100	0004	00 00000 0101		BET	RJ		// RESET CONDITION LATCH
AM - 1
0 0000 0101	0005	11 01101 1011	.RJ	CAK	MANT1
AM < 1
0 0000 0110	0006	01 00001 0011		BILT	ZERO
Test FA sign
0 0000 0111	0007	10 11010 0110	.S	TFA	SIGN
=0
0 0000 1000	0008	00 00000 1100		BIZ	RJ1
A -IOU -> A
...
Shift AM Right
0 0001 0000	0010	11 10111 1100		SRLA	MANT
AE - 1 -> AEA
0 0001 0001	0011	11 01001 1101		SAKA	EXP1
triangle
0 0001 0010	0012	00 00000 1100		BET	RJ1		// ALWAYS BRANCH
0 -> A ALL
0 0001 0011	0013	11 10000 1111	.ZERO	AKA	ALL
reset flag A sign
0 0001 0100	0014	10 11000 0110		ZFA	SIGN
Exchange A-B ALL
0 0001 0101	0015	11 10011 1111	.DPTPOS	EXAB	ALL
1 -> AM
0 0001 0110	0016	11 10000 1011		AKA	MANT1
AMT +1 -> AM
0 0001 0111	0017	11 00001 1011		AAKA	MANT1
Exchange A-B MAN
0 0001 1000	0018	11 10011 1100		EXAB	MANT
BE -> AE
0 0001 1001	0019	11 00011 1110		ABOA	EXP
AE - 1 > AE
0 0001 1010	001A	11 01001 1101	.DP1	SAKA	EXP1
<
0 0001 1011	001B	01 00001 1110		BILT	DP2
Shift BM Left
0 0001 1100	001C	11 10101 1100		SLLB	MANT
triangle
0 0001 1101	001D	00 00001 1010		BET	DP1		// ALWAYS BRANCH
BE -> AE
...
sync
0 0010 0001	0021	10 10101 0000	.LOCK	SYNC
scan
...
0 -> CE
0 0010 1000	0028	11 10010 1110	.IDLE	AKC	EXP
Reset Flag FD
0 0010 1001	0029	10 10111 1000	.ID1	ZFB	F10
wait NOP?
0 0010 1010	002A	10 10010 0111	.ID2	WAITNO	ID3
sync
0 0010 1011	002B	10 10101 0000	.ID4	SYNC
scan
0 0010 1100	002C	10 10110 0000		SCAN
bid?
0 0010 1101	002D	01 00110 1000		BID	KEY
CE + 1 -> CE
0 0010 1110	002E	11 11101 1101	.FD1	ACKA	EXP1
CE - 4 ???
0 0010 1111	002F	11 01111 0001		CCK	TIM4
<?
...
wait DK?
0 0011 0011	0033	10 10001 0001		WAITDK	ID5
-----
Test F OVF
0 0011 0100	0034	10 11001 0101	.FD3	TFB	F5		// OVERFLOW FLAG
=0?
...
----
set flag c.o. ii
0 0011 1101	003D	10 10011 0001	.MINKEY	SFB	OP2
test f cd
0 0011 1110	003E	10 11010 0011		TFA	F3
=0?
0 0011 1111	003F	00 00100 1101		BIZ	PLSKEY
test f
0 0100 0000	0040	10 11010 0100		TFA	F4
=1?
0 0100 0001	0041	01 00100 1101		BIO	PLSKEY
test f poi
0 0100 0010	0042	10 11010 0000		TFA	OP1
=0
0 0011 1111	0043	00 00100 1101		BIZ	PLSKEY ; wrong instruction in code
;;0 0100 0011	0043	00 00100 1101		ZFB	OP2		// MINUS KEY AS SIGN AFTER MULT OR DIVIDE
0 0100 0100	0044	10 10111 0001		ZFB	OP2 ; missing in  code
;0 0100 0100	0044	00 00000 0000		DB	0		// MISSING OPCODE ???
set flag asign
0 0100 0101	0045	10 10100 0110		SFA	SIGN
0 -> a all
0 0100 0110	0046	11 10000 1111		AKA	ALL
set flag
0 0100 0111	0047	10 10100 0111		SFA	F9
ad + 7 -> ad
0 0100 1000	0048	11 00001 0000		AAKA	DPT7
0 -> a all
0 0100 1001	0049	10 11000 0011		ZFA	F3
triangle
0 0100 1010	004A	00 00000 0111		BET	S		// ALWAYS BRANCH
0 0100 1011	004B	10 10011 0001	.DIVKEY	SFB	OP2
0 0100 1100	004C	10 10011 0000	.MLTKEY	SFB	OP1
0 0100 1101	004D	10 10011 0010	.PLSKEY	SFB	OP3
...
0 0101 0100	0054	00 00101 0110		BET	KS2		// ALWAYS BRANCH

0 0101 0101	0055	10 10100 0100	.EQLKEY	SFA	F4
0 0101 0110	0056	11 01101 1011	.KS2	CAK	MANT1
0 0101 0111	0057	01 01001 1110		BILT	KS6
0 0101 1000	0058	11 01101 1000	.KS3	CAK	OV1		// LEFT JUSTIFY
0 0101 1001	0059	00 10010 1011		BIGE	KS4
0 0101 1010	005A	11 10100 1100		SLLA	MANT
0 0101 1011	005B	11 00001 1101		AAKA	EXP1
0 0101 1100	005C	00 00101 1000		BET	KS3		// ALWAYS BRANCH
0 0101 1101	005D	10 10100 1000	.DPTKEY	SFA	F10
0 0101 1110	005E	10 11000 0111		ZFA	F9
0 0101 1111	005F	10 11010 0011		TFA	F3
0 0110 0000	0060	00 00001 0101		BIZ	DPTPOS
0 0110 0001	0061	10 11000 0011		ZFA	F3
0 0110 0010	0062	00 00001 0011		BET	ZERO		// ALWAYS BRANCH
...
0 0110 0111	0067	00 00001 0011		BET	ZERO		// ALWAYS BRANCH
----
BE -> CE
0 0110 1000	0068	11 00100 1110	.KEY	ABOC	EXP
Test F OVF
0 0110 1001	0069	10 11001 0101		TFB	F5
=1?
0 0110 1010	006A	01 00010 0001		BIO	LOCK
SYNC
0 0110 1011	006B	10 10101 0000		SYNC
SYNC ??? missing sync
...
bk?
0 0111 0001	0071	10 00000 0000		BKO	CLEAR
bk?
0 0111 0010	0072	10 00101 0101		BKO	EQLKEY
bk?
0 0111 0011	0073	10 00100 1101		BKO	PLSKEY
bk?
0 0111 0100	0074	10 00011 1101		BKO	MINKEY
bk?
0 0111 0101	0075	10 00100 1100		BKO	MLTKEY
bk?
0 0111 0110	0076	10 00100 1011		BKO	DIVKEY
bk?
0 0111 0111	0077	10 00110 0011		BKO	CEKEY
bk?
0 0111 1000	0078	10 00101 1101		BKO	DPTKEY
bk?
0 0111 1001	0079	10 00111 1110		BKO	ZERKEY
//
//						DIGIT ENTRY
//						-----------
//
Exchange A-B ALL
0 0111 1010	007A	11 10011 1111		EXAB	ALL
scan n
0 0111 1011	007B	11 11010 0010		AKCM	LSD1		// SCAN N
exchange A-B ALL
0 0111 1100	007C	11 10011 1111		EXAB	ALL
ovf?
0 0111 1101	007D	01 00001 0101		BIC	DPTPOS
test FCD
...
test F FST ??? Flowchart Line here should be on =0 below
0 1000 1010	008A	10 11010 0111	.NUM2	TFA	F9
=0? ??? Flowchart line here should be on =1 below
...
triangle
0 1001 0011	0093	00 01001 1100		BET	NUM6		// ALWAYS BRANCH
A-1 MSD
...
Test FDPT
0 1001 1000	0098	10 11010 1000	.NUM4	TEA	F10
=0?
...
triangle
0 1001 1101	009D	00 00001 0101		BET	DPTPOS		// ALWAYS BRANCH
Note: skips ahead in flowchart
0 -> AE
...
//						--------------------
//
0 1010 1111	00AF	10 11001 0110	.ADDSUB	TFB	SIGN
0 1011 0000	00B0	00 01011 0010		BIZ	AS1
0 1011 0001	00B1	10 10100 0101		SFA	F5
0 1011 0010	00B2	10 11010 0001	.AS1	TFA	OP2
0 1011 0011	00B3	00 01011 0101		BIZ	AS2
0 1011 0100	00B4	10 11011 0110		FFB	SIGN
0 1011 0101	00B5	11 01100 1110	.AS2	CAB	EXP
0 1011 0110	00B6	00 01011 1001		BIGE	AS3
0 1011 0111	00B7	11 10011 1111		EXAB	ALL
0 1011 1000	00B8	10 11111 0110		EXF	SIGN
0 1011 1001	00B9	11 01001 1101	.AS3	SAKA	EXP1
0 1011 1010	00BA	11 01100 1110		CAB	EXP
0 1011 1011	00BB	01 01011 1110		BILT	AS4
0 1011 1100	00BC	11 10111 1100		SRLA	MANT
0 1011 1101	00BD	00 01011 1001		BET	AS3		// ALWAYS BRANCH
0 1011 1110	00BE	11 00001 1101	.AS4	AAKA	EXP1
0 1011 1111	00BF	00 01100 0000		BET	AS5		// RESET CONDITION
0 1100 0000	00C0	11 01100 1100	.AS5	CAB	MANT
0 1100 0001	00C1	00 01100 0100		BIGE	AS6
0 1100 0010	00C2	11 10011 1111		EXAB	ALL
0 1100 0011	00C3	10 11111 0110		EXF	SIGN
0 1100 0100	00C4	10 11101 0110	.AS6	CF	SIGN
0 1100 0101	00C5	00 01100 1000		BIE	AS7
0 1100 0110	00C6	11 00111 1100		SABA	MANT
0 1100 0111	00C7	00 01100 1001		BET	AS8		// ALWAYS BRANCH
0 1100 1000	00C8	11 00000 1100	.AS7	AABA	MANT
0 1100 1001	00C9	10 10111 0110	.AS8	ZFB	SIGN
0 1100 1010	00CA	10 11010 0101		TFA	F5
0 1100 1011	00CB	00 01111 1101		BIZ	POST
0 1100 1100	00CC	10 10011 0110		SFB	SIGN
0 1100 1101	00CD	10 11000 0101		ZFA	F5
0 1100 1110	00CE	00 01111 1101		BET	POST		// ALWAYS BRANCH

0 1100 1111	00CF	10 11101 0110	.MLTDIV	CF	SIGN
0 1101 0000	00D0	10 11000 0110		ZFA	SIGN
0 1101 0001	00D1	00 01101 0011		BIE	MD1
0 1101 0010	00D2	10 10100 0110		SFA	SIGN
...
//					--------
//
0 1101 0101	00D5	11 00010 1111		AAKC	ALL
0 1101 0110	00D6	11 10000 1100		AKA	MANT
0 1101 0111	00D7	11 00000 1110		AABA	EXP
0 1101 1000	00D8	11 01011 0010	.M1	SCKC	LSD1
0 1101 1001	00D9	01 01101 1100		BILT	M2
0 1101 1010	00DA	11 00000 1100		AABA	MANT
0 1101 1011	00DB	00 01101 1000		BET	M1		// ALWAYS BRANCH
0 1101 1100	00DC	11 11001 1100	.M2	SRLC	MANT
0 1101 1101	00DD	11 01111 1011		CCK	MANT1
0 1101 1110	00DE	01 01111 1100		BILT	MD2		// MULTIPLY DONE
0 1101 1111	00DF	11 10111 1100		SRLA	MANT
0 1110 0000	00E0	11 01001 1101		SAKA	EXP1
0 1110 0001	00E1	00 01101 1000		BIGE	M1
0 1110 0010	00E2	10 10011 0101		SFB	F5
0 1110 0011	00E3	00 01101 1000		BET	M1		// ALWAYS BRANCH
//
//					DIVIDE
//					------
//
0 1110 0100	00E4	11 01111 1011	.DIV	CCK	MANT1
0 1110 0101	00E5	01 01111 1010		BILT	ERR		// DIVIDE BY ZERO
0 1110 0110	00E6	11 00010 1111		AAKC	ALL
0 1110 0111	00E7	11 10000 1100	.D1	AKA	MANT
...
0 1110 1101	00ED	11 01110 1100	.D2	CCB	MANT
0 1110 1110	00EE	01 01111 0010		BILT	D3
0 1110 1111	00EF	11 01010 1100		SCBC	MANT
0 1111 0000	00F0	11 00001 0010		AAKA	LSD1
0 1111 0001	00F1	00 01110 1101		BET	D2		// ALWAYS BRANCH
0 1111 0010	00F2	11 01101 1010	.D3	CAK	MSD1
0 1111 0011	00F3	00 01111 1100		BIGE	MD2		// DIVIDE DONE
0 1111 0100	00F4	11 10110 1100		SLLC	MANT
0 1111 0101	00F5	11 10100 1100		SLLA	MANT
0 1111 0110	00F6	11 00001 1101		AAKA	EXP1
0 1111 0111	00F7	00 01110 1101		BINC	D2
0 1111 1000	00F8	10 10111 0101		ZFB	F5
0 1111 1001	00F9	00 01110 1101		BET	D2		// ALWAYS BRANCH
0 1111 1010	00FA	10 10011 0101	.ERR	SFB	F5
0 1111 1011	00FB	00 00001 0011		BET	ZERO		// ALWAYS BRANCH
0 1111 1100	00FC	11 00100 1111	.MD2	ABOC	ALL
//
//					POST NORM
//					---------
//
0 1111 1101	00FD	11 10001 1110	.POST	AKB	EXP
0 1111 1110	00FE	11 10001 0000		AKB	DPT7
0 1111 1111	00FF	11 01101 1000		CAK	OV1
1 0000 0000	0100	01 10000 1000		BILT	P1
1 0000 0001	0101	11 10111 1100		SRLA	MANT
1 0000 0010	0102	11 01001 1101		SAKA	EXP1
;;; 1 0000 0011	0103	00 01001 1101		BIGE	P1 TYPO
...
1 0000 0111	0107	01 10011 1001		BIC	OVF1		// ALWAYS BRANCH ?
1 0000 1000	0108	10 11001 0101	.P1	TFB	F5
1 0000 1001	0109	01 10000 0101		BIO	OVF
1 0000 1010	010A	11 01101 1011		CAK	MANT1
1 0000 1011	010B	01 10001 0010		BILT	P3
1 0000 1100	010C	11 01101 1010	.P2	CAK	MSD1
1 0000 1101	010D	00 10001 0100		BIGE	P4
1 0000 1110	010E	11 10100 1100		SLLA	MANT
1 0000 1111	010F	11 00001 1101		AAKA	EXP1
1 0001 0000	0110	00 10000 1100		BET	P2		// ALWAYS BRANCH
1 0001 0001	0111	00 00010 1011	.ID5	BET	ID4		// ALWAYS BRANCH
1 0001 0010	0112	11 00011 1110	.P3	ABOA	EXP
1 0001 0011	0113	10 11000 0110		ZFA	SIGN
1 0001 0100	0114	10 11001 0010	.P4	TFB	OP3
1 0001 0101	0115	00 10001 1101		BIZ	P7
1 0001 0110	0116	10 10011 0011		SFB	F3
1 0001 0111	0117	11 00010 1111	.P5	AAKC	ALL
1 0001 1000	0118	10 11101 0110		CF	SIGN
1 0001 1001	0119	00 10001 1011		BIE	P6
1 0001 1010	011A	10 11011 0110		FFB	SIGN
1 0001 1011	011B	10 11111 1001	.P6	EXF	OPFGS
1 0001 1100	011C	10 10111 1001		ZFB	OPFGS
1 0001 1101	011D	10 10100 0011	.P7	SFA	F3
1 0001 1110	011E	10 11000 0101		ZFA	F5
1 0001 1111	011F	11 01100 1110		CAB	EXP
1 0010 0000	0120	01 00000 0101		BILT	RJ
;;;1 0010 0001	0121	11 00111 1100		SABA	EXP TYPO
1 0010 0001	0121	11 00111 1110		SABA	EXP
1 0010 0010	0122	11 01101 1101	.P8	CAK	EXP1
1 0010 0011	0123	01 10010 1001		BILT	P9
1 0010 0100	0124	11 01001 1101		SAKA	EXP1
1 0010 0101	0125	11 10111 1100		SRLA	MANT
1 0010 0110	0126	00 10010 0010		BET	P8		// ALWAYS BRANCH
1 0010 0111	0127	00 00010 1011	.ID3	BET	ID4		// ALWAYS BRANCH
----
triangle
1 0010 1000	0128	00 00001 0101	.FD4	BET	DPTPOS		// ALWAYS BRANCH

1 0010 1001	0129	11 00001 0000	.P9	AAKA	DPT7
1 0010 1010	012A	00 00000 0101		BET	RJ		// ALWAYS BRANCH
1 0010 1011	012B	10 11010 0110	.KS4	TFA	SIGN
...
1 0011 0101	0135	00 10011 0001		BET	KS5		// ALWAYS BRANCH
1 0011 0110	0136	11 10111 1100	.KS9	SRLA	MANT
1 0011 0111	0137	11 01001 1101		SAKA	EXP1
1 0011 1000	0138	00 01010 0001		BET	KS7		// ALWAYS BRANCH
...
1 0011 1101	013D	01 00001 0101		BILT	DPTPOS		// ALWAYS BRANCH ?
//
// _____________________________________________________________________________________________________
//
