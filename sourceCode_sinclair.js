...
var sourceCode = [
  ...
  "         BIE    SETNEG",
  "         AAKA   EXP_S5 ; negate exponent",
  "         BIE    MAINLOOP ; if already neg, fall through subtract",
  "SETNEG   AAKA   MANT_S5 ; negate mantissa",
  ...
  "         EXAB   ALL ; switch arguments so A EXP > B EXP",
  "AEXPPOS  CAK    MANT1 ; what is MANT1?",
  "         BIE    BSHIFT2",
  "         EXAB   ALL",
  ...
  "         SCKC   MANT_S5",
  "         BIE    SUBTR ; signs different",
  "TRYADD   AABA   MANT ; add mantissas, or restore A if did SUBTR",
  "         BIE    WRAPUP ; branch if no overflow, i.e. did add",
  "         EXAB   MANT ; failed subtract: swap A and B and try again.",
  "         EXAB   MANT_S5",
  "SUBTR    SABA   MANT ; subtract mantissa",
  "         BINE   TRYADD ; A was smaller than B: try again",
  "         BIE    WRAPUP ; branch every time, success",
  "SIGNSNE  CAB    EXP ; compare EXP signs",
  "         BIE    LABEL95 ; branch A >= B",
  "         EXAB   MASK9 ; swap",
  "LABEL95  SABA   EXP ; subtract EXPs",
  ...
  "         BINE   LOGKEY",
  "         AKC    DIGIT ; clear C DIGIT, whatever that is",
  "         ACKB   ALL ; copy C to B",
  "         EXAB   MANT",
  "         ABAC   EXP_S5",
  "         SCKC   EXP_S5",
  "         BIE    SIGNSNE ; branch if signs different",
  "         AABA   EXP ; add exponents",
  ...
  "         TFA    LOW",
  "         BINE   ALOGRET ; Return to LABEL308 if LOW flag set (ANTILOG)",
  ...
  "         BIE    EXPPOS2",
  "LABEL159 AAKA   EXP_S5 ; Flip sign",
  ...
  "         TFB    NEWEXP",
  "         BINE   ALOGLOOP",
  "         ACKC   MASK9 ; Count number of iterations",
  ...
  "         EXAB   MANT",
  "         ZFA    UP_LOW",
  "         BINE   LABEL278 ; branch every time",
];
var objectCode = [
